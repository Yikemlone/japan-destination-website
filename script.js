...
function checkIfMoonClicked(event) {
    ...
    var heightTop = mtfuji.height * 0.10;
...
function showWeather(){
    ...
    var url = "https://api.openweathermap.org/data/2.5/weather?q=" + area + "&appid=8f79396cfae54035b4711465892ab9f6";
    ...
    xhr.onload = function() {
        ...
        weatherDisplay[2].innerHTML = "Tempature: " + convertToCelcius(data.main.temp) + "&#176;";
